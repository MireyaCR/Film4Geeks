	...
	return {
		...
		actions: {
			...
			login: async (email, password) => {
				...
				try {
					const resp = await fetch("https://3001-mireyacr-film4geeks-xdpdhzxnh28.ws-eu83.gitpod.io/api/token", requestOptions)
			...
			appendToken: () => {
				...
				fetch("https://3001-mireyacr-film4geeks-xdpdhzxnh28.ws-eu83.gitpod.io/api/token", opts)
				.then(response => 
					response.json()
				)
			...
			addDbSeen: async (id) => {
				...
				try{
				const resp = await fetch("https://3001-mireyacr-film4geeks-xdpdhzxnh28.ws-eu83.gitpod.io/api/user/seen", opts)
			...
			addDbFav: async (id) => {
				...
				try{
				const resp = await fetch("https://3001-mireyacr-film4geeks-xdpdhzxnh28.ws-eu83.gitpod.io/api/user/favourite", opts)
			...
			addDbPending: async (id) => {
				...
				try{
				const resp = await fetch("https://3001-mireyacr-film4geeks-xdpdhzxnh28.ws-eu83.gitpod.io/api/user/pending", opts)
